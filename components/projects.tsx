...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    initialDisplay: 6,
    loadMoreCount: 3,
    background: {"image":"/uploads/projects-background-1765114798828.png","video":"","color":"","opacity":0.3},
    projects: [{"image":"/uploads/project-1764141506715-1764141509798.png","video":"","title":"대한토지신탁 프로젝트 분석도","description":"대한토지신탁의 기업분석과 대한토지신탁에서 시행한 관리형 토지신탁사업으로 용인시 수지구 신봉동 오피스텔 신축사업의 원부, 사업구조도, 특약분석"},{"image":"/uploads/project-1764141961334-1764141961370.png","video":"","title":"인천시 계양구 병방동 433-1 경매물건분석","description":"GTX노선 확장, 계양테크노벨리 사업과 같은 개발호재 및 인천공항과 김포공항 모두 30분 이내 거리에 위치한 점을 기반으로 하여 물건 선정 후 분석자료 향후 가치 상승 기대"},{"image":"/uploads/project-1764146293383-1764146293726.png","video":"","title":"영풍 석포제련소 환경 문제에 대한 고찰","description":" 급격한 산업성장과 도시화로 인해 인프라가 형성되고, 발전하지만 산업성장과 도시화, 발전과 함께 비례해서 나타나는 환경오염 문제에 대하여 영풍 석포제련소를 중심으로 분석하고, 해결방안을 제시"},{"image":"/uploads/project-1764146926512-1764146927160.png","video":"","title":"토지이용계획 분석","description":"강원도 춘천시 서면 일대의 지역을 선정 후 브이월드앱을 기반으로 현재의 이용도보다 집약적이고 기술적인 부분에 맞춰 토지이용계획도를 분석 및 작성"},{"image":"/uploads/project-1765105384704-1765105386737.png","video":"","title":"출산율 감소로 인한 학교 용지 문제의 도시계획적 해결방안","description":"저출산 고령화 시대에 접어듦에 따라 폐교하는 학교가 늘어나고 그에 따라 유휴지로 놀고있는 학교용지가 증가. 이에 유휴지 확대방지, 유령도시 예방을 위해 빈 학교용지를 주차장용지, 세트장, 박물관 등의 활용방안을 해외의 다양한 사례를 참고하여 모색"},{"image":"/uploads/project-1765109537110-1765109537149.png","video":"","title":"크라운제과 기업분석","description":"크라운해태홀딩스의 연혁과 사업구조도를 조사하고, 다트전자공시의 반기보고서를 기반으로 크라운제과의 매출실적과 매출비중을 통해 크라운제과의 시장점유율, 영업이익을 분석"},{"image":"/uploads/project-1765109876916-1765109877903.png","video":"","title":"이글벳 기업분석","description":"이글벳이라는 회사에 대해 조사하고, 최근 자녀를 낳는 것보다 반려동물과 함께 사는 딩펫족, 펫팸족이 증가하는 사회현상에 따라 매출액과 영업이익이 비례하여 증가하는 것을 고려하여 향후 전망에 대해 기업 분석 "},{"image":"/uploads/project-1765114302700-1765114302741.png","video":"","title":"스튜디오 드래곤 기업분석","description":"스튜디오 드래곤이라는 회사에 대해 조사하고, 최근 영화관에 직접 방문하는 고객보다 OTT플랫폼을 이용하는 고객이 증가하는 만큼 ott플랫폼 시장 확대를 예측하여 매출액과 영업이익이 증가하며, 향후 더 큰 ott시장의 확대를 예측하여 기업 분석"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
